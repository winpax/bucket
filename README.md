...
|cargo-binstall|Binary installation for rust projects|1.10.11|
...
|signal|A cross-platform encrypted messaging service.|7.32.0|
|trash-cli|Cross platform cli for moving files into the trash|1.0.0|
|trunk|Build, bundle & ship your Rust WASM application to the web. |0.21.3|
