...
|powershell|PowerShell Core, the cross-platform task automation and configuration management framework/tool.|7.3.8|
...
|signal|A cross-platform encrypted messaging service.|6.36.0|
