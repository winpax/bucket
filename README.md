...
|cargo-binstall|Binary installation for rust projects|1.7.4|
...
|cargo-udeps|Find unused dependencies in Cargo.toml|0.1.49|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.22.3|
|gh-cli|GitHub's official command line tool|2.53.0|
...
|signal|A cross-platform encrypted messaging service.|7.16.0|
