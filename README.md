...
|cargo-binstall|Binary installation for rust projects|1.15.5|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.35.4|
...
|signal|A cross-platform encrypted messaging service.|7.71.0|
