...
|cargo-binstall|Binary installation for rust projects|1.3.0|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.13.3|
...
|sfsu|Stupid Fast Scoop Utilities. Incredibly fast replacements for commonly used Scoop commands, written in Rust.|1.4.11|
|signal|A cross-platform encrypted messaging service.|6.30.2|
