...
|cargo-binstall|Binary installation for rust projects|1.5.0|
...
|signal|A cross-platform encrypted messaging service.|6.43.1|
...
|trunk|Build, bundle & ship your Rust WASM application to the web. |0.18.4|
