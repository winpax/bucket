...
|cargo-binstall|Binary installation for rust projects|1.15.11|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.38.1|
|gh-cli|GitHub's official command line tool|2.83.1|
...
|signal|A cross-platform encrypted messaging service.|7.79.0|
