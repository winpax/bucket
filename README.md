...
|cargo-binstall|Binary installation for rust projects|1.10.21|
...
|cargo-udeps|Find unused dependencies in Cargo.toml|0.1.54|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.27.2|
|gh-cli|GitHub's official command line tool|2.65.0|
...
|sfsu|Stupid Fast Scoop Utilities. Incredibly fast replacements for commonly used Scoop commands, written in Rust.|1.15.1|
|signal|A cross-platform encrypted messaging service.|7.38.0|
