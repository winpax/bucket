...
|cargo-binstall|Binary installation for rust projects|1.20.1|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.44.6|
...
|powershell|PowerShell Core, the cross-platform task automation and configuration management framework/tool.|7.6.3|
|scarab|An installer for Hollow Knight mods written in Avalonia.|2.7.0.0|
|sfsu-beta|Stupid Fast Scoop Utilities. Incredibly fast replacements for commonly used Scoop commands, written in Rust.|1.17.4-beta.3|
|sfsu|Stupid Fast Scoop Utilities. Incredibly fast replacements for commonly used Scoop commands, written in Rust.|1.17.2|
|signal|A cross-platform encrypted messaging service.|8.18.0|
