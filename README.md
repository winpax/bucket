...
|cargo-binstall|Binary installation for rust projects|1.10.16|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.27.0|
...
|signal|A cross-platform encrypted messaging service.|7.36.0|
