...
|sfsu-beta|Stupid Fast Scoop Utilities. Incredibly fast replacements for commonly used Scoop commands, written in Rust.|1.11.0-beta.5|
...
|trunk|Build, bundle & ship your Rust WASM application to the web. |0.19.3|
