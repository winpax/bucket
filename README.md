...
|cargo-binstall|Binary installation for rust projects|1.16.6|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.38.6|
|gh-cli|GitHub's official command line tool|2.83.2|
...
|signal|A cross-platform encrypted messaging service.|7.84.0|
