...
|cargo-binstall|Binary installation for rust projects|1.15.4|
|cargo-deny|Cargo plugin for linting your dependencies|0.18.4|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.35.3|
|gh-cli|GitHub's official command line tool|2.79.0|
...
|powershell|PowerShell Core, the cross-platform task automation and configuration management framework/tool.|7.5.2|
...
|signal|A cross-platform encrypted messaging service.|7.69.0|
