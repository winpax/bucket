...
|cargo-binstall|Binary installation for rust projects|1.14.1|
...
|cargo-udeps|Find unused dependencies in Cargo.toml|0.1.56|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.32.5|
|gh-cli|GitHub's official command line tool|2.74.2|
...
|signal|A cross-platform encrypted messaging service.|7.58.0|
