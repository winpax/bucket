...
|cargo-binstall|Binary installation for rust projects|1.16.4|
|cargo-deny|Cargo plugin for linting your dependencies|0.18.9|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.38.5|
...
|signal|A cross-platform encrypted messaging service.|7.83.0|
