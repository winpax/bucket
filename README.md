...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.19.0|
...
|sfsu|Stupid Fast Scoop Utilities. Incredibly fast replacements for commonly used Scoop commands, written in Rust.|1.8.4|
|signal|A cross-platform encrypted messaging service.|6.47.1|
