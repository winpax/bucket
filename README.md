...
|gh-cli|GitHub's official command line tool|2.80.0|
...
|livesplit|A sleek, highly customizable timer for speedrunners.|1.8.34|
...
|signal|A cross-platform encrypted messaging service.|7.72.1|
