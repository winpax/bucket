...
|cargo-binstall|Binary installation for rust projects|1.4.7|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.16.4|
...
|sfsu|Stupid Fast Scoop Utilities. Incredibly fast replacements for commonly used Scoop commands, written in Rust.|1.6.2|
|signal|A cross-platform encrypted messaging service.|6.41.0|
...
|trunk|Build, bundle & ship your Rust WASM application to the web. |0.18.0|
