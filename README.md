...
|cargo-binstall|Binary installation for rust projects|1.18.1|
|cargo-deny|Cargo plugin for linting your dependencies|0.19.4|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.41.8|
...
|signal|A cross-platform encrypted messaging service.|8.8.0|
