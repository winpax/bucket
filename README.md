...
|cargo-binstall|Binary installation for rust projects|1.23.0|
|cargo-deny|Cargo plugin for linting your dependencies|0.20.2|
|cargo-fuzz|Command line helpers for fuzzing|0.13.2|
|cargo-outdated|A cargo subcommand for displaying when Rust dependencies are out of date|0.19.0|
|cargo-udeps|Find unused dependencies in Cargo.toml|0.1.61|
|chatterino2|Chat client for https://twitch.tv |2.5.5|
|chatterino7|Chat client for Twitch, with added 7tv emote support|7.5.5|
...
|evcxr|An evaluation context for Rust|0.22.0|
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.47.2|
|gh-cli|GitHub's official command line tool|2.100.0|
...
|powershell|PowerShell Core, the cross-platform task automation and configuration management framework/tool.|7.6.5|
|scarab|An installer for Hollow Knight mods written in Avalonia.|2.7.0.0|
|sfsu-beta|Stupid Fast Scoop Utilities. Incredibly fast replacements for commonly used Scoop commands, written in Rust.|1.17.4|
|sfsu|Stupid Fast Scoop Utilities. Incredibly fast replacements for commonly used Scoop commands, written in Rust.|1.17.4|
|signal|A cross-platform encrypted messaging service.|8.26.0|
