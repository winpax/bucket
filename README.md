...
|cargo-binstall|Binary installation for rust projects|1.10.3|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.24.1|
...
|signal|A cross-platform encrypted messaging service.|7.21.0|
