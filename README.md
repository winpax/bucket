...
|cargo-binstall|Binary installation for rust projects|1.10.10|
...
|cargo-udeps|Find unused dependencies in Cargo.toml|0.1.52|
...
|gh-cli|GitHub's official command line tool|2.60.1|
...
|signal|A cross-platform encrypted messaging service.|7.31.0|
|trash-cli|Cross platform cli for moving files into the trash|1.0.0|
|trunk|Build, bundle & ship your Rust WASM application to the web. |0.21.2|
