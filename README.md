...
|cargo-deny|Cargo plugin for linting your dependencies|0.18.6|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.38.3|
...
|signal|A cross-platform encrypted messaging service.|7.80.0|
