...
|cargo-binstall|Binary installation for rust projects|0.22.0|
...
|Clipboard|📋 Cut, copy, and paste anything, anywhere, all from the terminal. 😄 Easy, breezy, and beautiful.|0.6.0|
...
|flutter|Google's mobile app SDK for crafting high-quality native interfaces on iOS and Android|3.7.11|
...
|signal|A cross-platform encrypted messaging service.|6.14.0|
