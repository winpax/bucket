...
|cargo-binstall|Binary installation for rust projects|1.10.5|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.24.2|
|gh-cli|GitHub's official command line tool|2.56.0|
...
|signal|A cross-platform encrypted messaging service.|7.24.0|
