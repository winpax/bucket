...
|cargo-deny|Cargo plugin for linting your dependencies|0.19.8|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.44.1|
...
|powershell|PowerShell Core, the cross-platform task automation and configuration management framework/tool.|7.6.2|
