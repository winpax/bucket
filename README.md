...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.44.8|
|gh-cli|GitHub's official command line tool|2.96.0|
...
|powershell|PowerShell Core, the cross-platform task automation and configuration management framework/tool.|7.6.4|
...
|signal|A cross-platform encrypted messaging service.|8.20.0|
