...
|cargo-binstall|Binary installation for rust projects|1.20.0|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.44.2|
|gh-cli|GitHub's official command line tool|2.94.0|
...
|signal|A cross-platform encrypted messaging service.|8.14.0|
