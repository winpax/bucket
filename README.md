...
|cargo-binstall|Binary installation for rust projects|1.14.4|
...
|sfsu-beta|Stupid Fast Scoop Utilities. Incredibly fast replacements for commonly used Scoop commands, written in Rust.|1.17.0-beta.3|
|sfsu|Stupid Fast Scoop Utilities. Incredibly fast replacements for commonly used Scoop commands, written in Rust.|1.17.0|
|signal|A cross-platform encrypted messaging service.|7.65.0|
