...
|cargo-binstall|Binary installation for rust projects|1.19.1|
|cargo-deny|Cargo plugin for linting your dependencies|0.19.6|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.44.0|
|gh-cli|GitHub's official command line tool|2.92.0|
...
|powershell|PowerShell Core, the cross-platform task automation and configuration management framework/tool.|7.6.1|
...
|signal|A cross-platform encrypted messaging service.|8.11.0|
