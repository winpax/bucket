...
|cargo-binstall|Binary installation for rust projects|1.21.0|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.44.7|
...
|signal|A cross-platform encrypted messaging service.|8.19.0|
