...
|cargo-binstall|Binary installation for rust projects|1.6.0|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.16.8|
...
|signal|A cross-platform encrypted messaging service.|6.44.0|
