...
|cargo-binstall|Binary installation for rust projects|1.17.4|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.38.8|
...
|signal|A cross-platform encrypted messaging service.|7.86.0|
