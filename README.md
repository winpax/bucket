...
|cargo-binstall|Binary installation for rust projects|1.12.1|
...
|signal|A cross-platform encrypted messaging service.|7.46.1|
|trunk|Build, bundle & ship your Rust WASM application to the web. |0.21.9|
