...
|cargo-binstall|Binary installation for rust projects|1.17.6|
...
|flutter|Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop|3.41.2|
|gh-cli|GitHub's official command line tool|2.87.3|
...
|signal|A cross-platform encrypted messaging service.|8.0.0|
